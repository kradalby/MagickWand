...
class ImageWandTests: XCTestCase {
  ...
  func testInitWithColor() {
    ...
    guard let savedImageWand = self.open(file: "images/testInitWithColor", ofType: "png") else {
      return
    }
  ...
  func testInitWithFilePath() {
    ...
    guard let savedImageWand = self.open(file: "images/testInitWithFilePath", ofType: "png") else {
      return
    }
  ...
  func testWriteImage() {
    ...
    let url = URL(fileURLWithPath: "images/testInitWithFilePath.png")
    XCTAssertTrue(imageWand.write(at: url))
